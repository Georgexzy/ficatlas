...
export default function TakedownQueue() {
  ...
  // The shell, the header, the back link and both auth gates now live on the
  // admin page that renders this — they were identical in both files, and the
  // "not an operator" branch in particular must stay in exactly one place so it
  // cannot drift into being laxer here than there.
